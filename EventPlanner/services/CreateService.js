...
import {Text, View, TextInput, StyleSheet, Alert, Pressable, Button, Touchable, TouchableOpacity} from 'react-native';
    ...
    return (
            ...
            <View style={styles.View}>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity style={styles.button} onPress={handleSubmit(handleSubmission)} >
                    <Text>Submit</Text>
                    </TouchableOpacity>
